...
var _this = this;
var axios = __nccwpck_require__(19);
(__nccwpck_require__(406).config)();
try {
    var secretKey = process.env.GITHUB1;
...
var getRepoInfo = function (url) { return __awaiter(_this, void 0, void 0, function () {
...
module.exports =
{
  parallel      : __nccwpck_require__(266),
  serial        : __nccwpck_require__(979),
  serialOrdered : __nccwpck_require__(54)
};
...
var defer = __nccwpck_require__(960);
...
var async = __nccwpck_require__(132)
...
var iterate    = __nccwpck_require__(937)
  , initState  = __nccwpck_require__(57)
  , terminator = __nccwpck_require__(127)
  ;
...
var serialOrdered = __nccwpck_require__(54);
...
module.exports = function () {
  if (!debug) {
    try {
      ...
      debug = __nccwpck_require__(969)("follow-redirects");
    }
    catch (error) { /* */ }
...
var debug = __nccwpck_require__(116);
...
var CombinedStream = __nccwpck_require__(336);
var util = __nccwpck_require__(837);
...
var Stream = (__nccwpck_require__(781).Stream);
var mime = __nccwpck_require__(720);
var asynckit = __nccwpck_require__(327);
var populate = __nccwpck_require__(918);
...
const FormData$1 = __nccwpck_require__(346);
const url = __nccwpck_require__(310);
const proxyFromEnv = __nccwpck_require__(404);
const http = __nccwpck_require__(685);
const https = __nccwpck_require__(687);
const followRedirects = __nccwpck_require__(139);
